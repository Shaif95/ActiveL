...
if __name__ == '__main__':
    ...
    parser.add_argument('-epochs', default=10, type=int, help="Number of epoch to train. default: 5")
    ...
    parser.add_argument('-i', '--initial_annotated_perc', default=0.05, type=float,
